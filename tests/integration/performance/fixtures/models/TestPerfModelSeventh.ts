...
export default async function buildTestPerfModelSeventh({
  config,
  getModel,
  getBlock,
}: BuilderContext) {
  return new ModelBuilder({
    name: "Performance Test Model Seventh",
    config,
    body: {
      api_key: "test_perf_model_seventh",
      hint: "Performance test model Seventh",
    },
  })
    .addText({
      label: "Title",
