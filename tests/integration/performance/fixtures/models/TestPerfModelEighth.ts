...
export default async function buildTestPerfModelEighth({
  config,
  getModel,
  getBlock,
}: BuilderContext) {
  return new ModelBuilder({
    name: "Performance Test Model Eighth",
    config,
    body: {
      api_key: "test_perf_model_eighth",
      hint: "Performance test model Eighth",
    },
  })
    .addText({
      label: "Title",
