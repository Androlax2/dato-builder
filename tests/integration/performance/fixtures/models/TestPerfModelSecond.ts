...
export default async function buildTestPerfModelSecond({
  config,
  getModel,
  getBlock,
}: BuilderContext) {
  return new ModelBuilder({
    name: "Performance Test Model Second",
    config,
    body: {
      api_key: "test_perf_model_second",
      hint: "Performance test model Second",
    },
  })
    .addText({
      label: "Title",
